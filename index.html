  ...
  <body>
    <div id="borders">
      ...
      <nav class="navbar">
        <div class="container-fluid">
          ...
          <ul class="nav navbar-nav">
            <li class="sliding-middle-out"><a href="#" onclick="home()">Home</a></li>
            <li class="sliding-middle-out"><a href="#" onclick="about()">About Us</a></li>
            <li class="sliding-middle-out"><a href="#" onclick = "team()">Our Team</a></li>
          </ul>
        </div>
      </nav>
      <div id="heroWrapper">
        ...
        <div id="heroInner" class="carousel slide" data-ride="carousel">
          <div class="carousel-inner" role="listbox">
            <div class="item active">
              <img id="img1" src="img/grey-laptop.png" alt="laptop" height="200" width="300">
            </div>
            <div class="item">
      ...
      <div id="section1">
        ...
        <div id="team" class="us">
          <h2>OUR TEAM</h2><br>
          <h3>CO-FOUNDERS</h3><br>
          <div class="container">
            <div class="row">
              <div class="col-sm-6">
                <div class="sign" style="background: url(img/ajay.png) no-repeat"></div>

              </div>
              <div class="col-sm-6">
                <div class="sign" style="background: url(img/jon.png) no-repeat"></div>

              </div>
            </div>
          </div>
          <h3>DEVELOPER</h3><br>
          <div class="sign" style="background: url(img/akash.png) no-repeat"></div>
